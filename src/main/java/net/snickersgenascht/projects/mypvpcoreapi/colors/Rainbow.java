package net.snickersgenascht.projects.mypvpcoreapi.colors;

import net.snickersgenascht.projects.mypvpcoreapi.colors.exceptions.HomogeneousRainbowException;
import net.snickersgenascht.projects.mypvpcoreapi.colors.exceptions.InvalidColourException;
import net.snickersgenascht.projects.mypvpcoreapi.colors.exceptions.NumberRangeException;
