package net.snickersgenascht.projects.mypvpcoreapi.colors.manager;

import net.snickersgenascht.projects.mypvpcoreapi.colors.ChatColor;
import net.snickersgenascht.projects.mypvpcoreapi.colors.Rainbow;
